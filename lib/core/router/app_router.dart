...
import '../../pages/student/quiz/quiz_list_by_matiere_page.dart';
import '../../pages/student/quiz/quiz_detail_page.dart';
import '../../pages/student/quiz/quiz_session_page.dart';
  ...
  return GoRouter(
    ...
    redirect: (BuildContext context, GoRouterState state) {
      ...
      if (!isLoggedIn) {
        ...
        if (currentLocation == '/get-started' ||
        ...
        if (userRole == 'student' &&
            (currentLocation.startsWith('/admin') ||
                currentLocation.startsWith('/teacher') ||
                currentLocation == '/staff-login')) return '/cours';
        if (userRole == 'teacher' &&
            (currentLocation.startsWith('/admin') ||
                currentLocation == '/staff-login')) return '/teacher/dashboard';
    ...
    routes: <RouteBase>[
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          final chapitreId =
          chapitreIdString != null ? int.tryParse(chapitreIdString) : null;
          if (chapitreId == null) {
      ...
      GoRoute(
        ...
        builder: (context, state) => const Center(
          child: Text(
              "Pour ajouter une leçon, passez par la gestion des cours du tableau de bord enseignant."),
        ),
      ),
      GoRoute(
        ...
        builder: (context, state) => const Center(
          child: Text(
              "Pour modifier une leçon, passez par la gestion des cours du tableau de bord enseignant."),
        ),
      ),
      GoRoute(
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          if (epreuve == null) {
            return const Scaffold(
              body: Center(
                child: Text('Erreur: Détails de l\'épreuve non fournis.'),
              ),
            );
          }
      ...
      GoRoute(
        path: '/quiz_matiere_selection',
        name: 'quiz_matiere_selection',
        builder: (context, state) => const QuizMatiereSelectionPage(),
      ),
      GoRoute(
        path: '/quiz_list_matiere',
        name: 'quiz_list_matiere',
        builder: (context, state) {
          final matiere = state.extra as MatiereModel;
          return QuizListByMatierePage(matiere: matiere);
        },
      ),
      GoRoute(
        path: '/quiz_detail',
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return QuizResultsPage(results: results);
        },
      ),
